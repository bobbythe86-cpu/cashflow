            ...
            {completedGoals.length > 0 && (
                <div className="space-y-6 pt-8 border-t border-white/5">
                    <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <h3 className="text-sm font-bold uppercase tracking-widest">Archivált Célok</h3>
                    </div>
                    <div className="grid gap-6 md:grid-cols-2 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
                        {completedGoals.map((goal) => (
                            <SavingsDetailsDialog key={goal.id} goal={goal}>
                                <Card className="border-none shadow-xl glass overflow-hidden cursor-pointer p-6 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Teljesítve: {goal.target_amount.toLocaleString()} Ft</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-green-500">Sikeres</span>
                                    </div>
                                </Card>
                            </SavingsDetailsDialog>
                        ))}
